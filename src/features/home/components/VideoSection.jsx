            ...
            {socialMediaContent.tiktok.map((post) => (
              ...
              >
                <div
                  ...
                  style={{ maxWidth: "100%", minHeight: "580px" }}
                >
                  <blockquote
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">
            Video Kegiatan & Edukasi <span className="text-blue-600">CMI</span>
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Ikuti kegiatan dan dapatkan informasi kesehatan terbaru dari Klinik
            Utama CMI melalui berbagai platform sosial media kami.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-3 justify-center mb-6">
          <TabButton
            ...
            icon={
              <Play
                size={18}
                className={
                  activeTab === "youtube" ? "text-white" : "text-red-600"
                }
              />
            }
          ...
          <TabButton
            ...
            icon={
              <Instagram
                size={18}
                className={
                  activeTab === "instagram" ? "text-white" : "text-pink-600"
                }
              />
            }
          ...
          <TabButton
            ...
            icon={
              <Video
                size={18}
                className={activeTab === "tiktok" ? "text-white" : "text-black"}
              />
            }
